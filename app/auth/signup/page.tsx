...
import { Sword, Mail, Lock, Eye, EyeOff, User } from "lucide-react";
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground">Join Revisare</h1>
          <p className="text-sm text-foreground-muted mt-1">Start debating in minutes</p>
        </div>
        ...
        <div className="relative my-5">
          ...
          <div className="relative flex justify-center">
            <span className="px-3 bg-background text-xs text-foreground-subtle">or email</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <Input
            ...
            hint="Public identity. Only changeable once per year."
